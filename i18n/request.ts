...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  const [
    ...
    import(`./messages/components/CollectionDialog.${locale}.json`),
    ...
    import(`./messages/components/MyStoryMapsTab.${locale}.json`),
    ...
    import(`./messages/pages/CreateStoryMapPage.${locale}.json`),
    ...
    import(`./messages/pages/AboutPage.${locale}.json`)
  ]);
  ...
  return {
    ...
    messages: {
      ...
      ...componentsCollectionDialog.default,
      ...
      ...componentsMyStoryMapsTab.default,
      ...
      ...pagesCreateStoryMapPage.default,
